#!/usr/bin/env node
// PreToolUse(Edit|Write|MultiEdit): 현재 브랜치가 서버 branch_locks에 잠겨 있으면
// systemMessage로 경고 1줄을 표시한다. 차단하지 않는다(permissionDecision 미사용 —
// ask는 과개입). status 5분 캐시는 proxy 측이며, proxy 부재 시 무출력 fail-open.
