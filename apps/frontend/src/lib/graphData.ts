...
export const GRAPH_EXPANDED = {
  ...
  nodes: [
    { id: "overview", dir: "CORE", name: "overview.md", title: "프로젝트 개요 · 세션 주입 본체", dark: true, width: 224, x: 350, y: 260 },
    { id: "index", dir: "CORE", name: "index.md", title: "전 페이지 카탈로그", dark: true, width: 188, x: 400, y: 88 },
    { id: "log", dir: "CORE", name: "log.md", title: "append-only 활동 이력", dark: true, width: 188, x: 110, y: 580 },
    { id: "stop-gate", dir: "SPECS", name: "stop-gate.md", title: "Stop 게이트 판정 규칙", selected: true, width: 212, x: 600, y: 196 },
    { id: "mcp-proxy", dir: "SPECS", name: "mcp-proxy.md", title: "stdio 프록시 · 도구 3종", width: 208, x: 612, y: 392 },
    { id: "ingest-pipeline", dir: "SPECS", name: "ingest-pipeline.md", title: "ingest 처리 파이프라인", width: 216, x: 400, y: 470 },
    { id: "query-engine", dir: "SPECS", name: "query-engine.md", title: "인용 포함 질의 응답", width: 208, x: 180, y: 420 },
    { id: "llm-engine", dir: "ARCHITECTURE", name: "llm-engine.md", title: "4종 에이전트 루프", width: 208, x: 88, y: 150 },
    { id: "git-sync", dir: "ARCHITECTURE", name: "git-sync.md", title: "브랜치 미러링 · lazy 전파", width: 216, x: 64, y: 322 },
    { id: "adr-002", dir: "DECISIONS", name: "adr-002-hard-gate.md", title: "spec 무결성 > 가용성", width: 224, x: 840, y: 560 },
    { id: "progress", dir: "PROGRESS", name: "progress.md", title: "마일스톤 진행 현황", width: 200, x: 560, y: 620 },
    { id: "adr-001", dir: "DECISIONS", name: "adr-001-bare-git.md", title: "wiki SoT = bare git repo", width: 216, x: 330, y: 640 },
  ] satisfies GraphNode[],
  panelX: 860,
}
...
export const GRAPH_COLLAPSED = {
  ...
  nodes: [
    { id: "overview", dir: "CORE", name: "overview.md", title: "프로젝트 개요 · 세션 주입 본체", dark: true, width: 224, x: 400, y: 262 },
    { id: "index", dir: "CORE", name: "index.md", title: "전 페이지 카탈로그", dark: true, width: 188, x: 460, y: 88 },
    { id: "log", dir: "CORE", name: "log.md", title: "append-only 활동 이력", dark: true, width: 188, x: 120, y: 588 },
    { id: "stop-gate", dir: "SPECS", name: "stop-gate.md", title: "Stop 게이트 판정 규칙", selected: true, width: 212, x: 700, y: 196 },
    { id: "mcp-proxy", dir: "SPECS", name: "mcp-proxy.md", title: "stdio 프록시 · 도구 3종", width: 208, x: 716, y: 398 },
    { id: "ingest-pipeline", dir: "SPECS", name: "ingest-pipeline.md", title: "ingest 처리 파이프라인", width: 216, x: 460, y: 478 },
    { id: "query-engine", dir: "SPECS", name: "query-engine.md", title: "인용 포함 질의 응답", width: 208, x: 200, y: 430 },
    { id: "llm-engine", dir: "ARCHITECTURE", name: "llm-engine.md", title: "4종 에이전트 루프", width: 208, x: 100, y: 150 },
    { id: "git-sync", dir: "ARCHITECTURE", name: "git-sync.md", title: "브랜치 미러링 · lazy 전파", width: 216, x: 72, y: 330 },
    { id: "adr-002", dir: "DECISIONS", name: "adr-002-hard-gate.md", title: "spec 무결성 > 가용성", width: 224, x: 960, y: 560 },
    { id: "progress", dir: "PROGRESS", name: "progress.md", title: "마일스톤 진행 현황", width: 200, x: 640, y: 628 },
    { id: "adr-001", dir: "DECISIONS", name: "adr-001-bare-git.md", title: "wiki SoT = bare git repo", width: 216, x: 380, y: 650 },
  ] satisfies GraphNode[],
  panelX: 1012,
}
...
export const DOT_MODE = {
  ...
  hubs: [
    { x: 494, y: 324, size: 12, radius: 2.5, dark: true, label: "overview", labelX: 512, labelY: 310, labelStrong: true },
    { x: 634, y: 194, size: 12, radius: 2.5, dark: true, label: "index", labelX: 652, labelY: 180, labelStrong: true },
    { x: 294, y: 554, size: 12, radius: 2.5, dark: true, label: "log", labelX: 312, labelY: 540, labelStrong: true },
...
export const MOBILE_GRAPH = {
  viewBox: "0 0 390 360",
  edges:
    "M167 36c-43.5 0-43.5 100-87 100m0 0c-3.5 0-3.5 108-7 108m0 0c72 0 72 38 144 38",
  edgesActive:
    "M80 136c94.5 0 94.5-18 189-18m0 0c15 0 15 84 30 84m-30-84c-26 0-26 164-52 164",
  nodes: [
    ...
    { id: "stop-gate", dir: "SPECS", name: "stop-gate.md", selected: true, width: 114, x: 212, y: 98 },
...
export const MOBILE_DOT_MODE = {
  ...
  hubs: [
    ...
    { x: 100, y: 250, size: 10, radius: 2, dark: true, label: "overview", labelX: 114, labelY: 239 },
...
export const DOC_ROWS: DocRow[] = [
  { id: "stop-gate", prefix: "specs/", name: "stop-gate.md", summary: "Stop 게이트 판정 규칙", links: 4, updated: "2시간 전", author: "SY", highlighted: true },
  { id: "log", name: "log.md", summary: "append-only 활동 이력", links: 2, updated: "2시간 전", author: "SY", dark: true },
  { id: "index", name: "index.md", summary: "전 페이지 카탈로그 · 매 ingest 갱신", links: 12, updated: "2시간 전", author: "SY", dark: true },
  { id: "ingest-pipeline", prefix: "specs/", name: "ingest-pipeline.md", summary: "ingest 처리 파이프라인", links: 4, updated: "5시간 전", author: "MJ" },
  { id: "overview", name: "overview.md", summary: "프로젝트 개요 · 세션 주입 본체", links: 6, updated: "어제", author: "MJ", dark: true },
  { id: "mcp-proxy", prefix: "specs/", name: "mcp-proxy.md", summary: "stdio 프록시 · 도구 3종", links: 3, updated: "어제", author: "SY" },
  { id: "llm-engine", prefix: "architecture/", name: "llm-engine.md", summary: "4종 에이전트 루프", links: 3, updated: "2일 전", author: "DK" },
  { id: "query-engine", prefix: "specs/", name: "query-engine.md", summary: "인용 포함 질의 응답", links: 2, updated: "2일 전", author: "DK" },
  { id: "git-sync", prefix: "architecture/", name: "git-sync.md", summary: "브랜치 미러링 · lazy 전파", links: 2, updated: "3일 전", author: "MJ" },
  { id: "adr-002", prefix: "decisions/", name: "adr-002-hard-gate.md", summary: "spec 무결성 > 가용성", links: 2, updated: "4일 전", author: "SY" },
  { id: "adr-001", prefix: "decisions/", name: "adr-001-bare-git.md", summary: "wiki SoT = bare git repo", links: 2, updated: "5일 전", author: "DK" },
  { id: "progress", name: "progress.md", summary: "마일스톤 진행 현황", links: 1, updated: "5일 전", author: "MJ", dark: true },
]
...
export const MOBILE_DOC_ROWS: MobileDocRow[] = [
  ...
  { id: "ingest-pipeline", name: "ingest-pipeline.md", summary: "ingest 처리 파이프라인", time: "5시간 전" },
  { id: "overview", name: "overview.md", summary: "프로젝트 개요 · 주입 본체", time: "어제", dark: true },
